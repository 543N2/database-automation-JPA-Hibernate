...
public class Employee {
    ...
    public Employee(int idEmployee, String firstName, String lastName, String email, String phoneNumber, String address, float salary, String birthDate, int idCompany) {
